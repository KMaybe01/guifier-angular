...
var ALL_ENTITIES = __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, BASIC_LATIN), LATIN_ACCENTS), LATIN_EXTENDED), GREEK), CYRILLIC), MATH), MATH_ADVANCED), ARROWS), SHAPES), PUNCTUATION), CURRENCY), FRACTIONS), MISC_SYMBOLS);
var XML = {
  amp: "&",
  apos: "'",
  gt: ">",
...
// node_modules/.pnpm/@nodable+entities@2.1.0/node_modules/@nodable/entities/src/entityTries.js
...
// node_modules/.pnpm/@nodable+entities@2.1.0/node_modules/@nodable/entities/src/EntityEncoder.js
...
var Matcher = class {
  ...
  snapshot() {
    return {
      path: this.path.map((node) => __spreadValues({}, node)),
  ...
  restore(snapshot) {
    this._pathStringCache = null;
    this.path = snapshot.path.map((node) => __spreadValues({}, node));
...
var OrderedObjParser = class {
  constructor(options, externalEntities) {
    ...
    let namedEntities = __spreadValues({}, XML);
    if (this.options.entityDecoder) {
      this.entityDecoder = this.options.entityDecoder;
    } else {
      if (typeof this.options.htmlEntities === "object") namedEntities = this.options.htmlEntities;
      else if (this.options.htmlEntities === true) namedEntities = __spreadValues(__spreadValues({}, COMMON_HTML), CURRENCY);
      this.entityDecoder = new EntityDecoder({
        namedEntities: __spreadValues(__spreadValues({}, namedEntities), externalEntities),
